...
void debugCorrespondenceMatching() {
	...
	const std::string filenameSource = std::string("/config/workspace/Data/bunny_part2_trans.off");
	const std::string filenameTarget = std::string("/config/workspace/Data/bunny_part1.off");
...
int reconstructRoom() {
	std::string filenameIn = std::string("/config/workspace/Data/rgbd_dataset_freiburg1_xyz/");
